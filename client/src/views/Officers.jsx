...
import Kaier from '../assets/images/headshots/Kaier.jpg'
import Smith from '../assets/images/headshots/Smith.jpg'
import Hosman from '../assets/images/headshots/Hosman.jpg'
import Rasmussen from '../assets/images/headshots/Rasmussen.jpg'

const Officers = () => {
    return (
        <div id="officers" className="mx-4 md:mb-32 sm:mx-16 border-t border-gray-200">
            {/* <div id="officers-header" className="text-base my-2">
                <h1 className="text-2xl drop-shadow-lg">Our Officers</h1>
            </div> */}
            <div id="officers-body" className="px-4">
                <div className="officer py-4 flex flex-col items-center md:flex-row mt-8">
                    <img className='w-[90%] min-[400px]:w-[50%] sm:w-[40%] md:w-[30%] lg:w-[25%] h-auto min-[400px]:h-[50%] sm:h-[40%] md:h-[30%] lg:h-[25%] mb-4 sm:mb-0 sm:mt-2 sm:mr-4' src={Ikegami} alt="Headshot of Rick Ikegami" />
                    <div className=''>
                        <h2 className="pb-2 text-xl underline underline-offset-4 text-red-600 drop-shadow-md">Rick Ikegami, MBA – Founder and President</h2>
                ...
                <div className="officer py-4 flex flex-col items-center md:flex-row mt-8">
                    <img className='w-[90%] min-[400px]:w-[50%] sm:w-[40%] md:w-[30%] lg:w-[25%] h-auto min-[400px]:h-[50%] sm:h-[40%] md:h-[30%] lg:h-[25%] mb-4 sm:mb-0 sm:mt-2 sm:mr-4' src={Kaier} alt="Headshot of Jeremy Kaier" />
                    <div className=''>
                        <h2 className="pb-2 text-xl underline underline-offset-4 text-red-600 drop-shadow-md">Jeremy Kaier, DC – Vice President of Membership</h2>
                        <p className="text-base">
                ...
                <div className="officer py-4 flex flex-col items-center md:flex-row mt-8">
                    <img className='w-[90%] min-[400px]:w-[50%] sm:w-[40%] md:w-[30%] lg:w-[25%] h-auto min-[400px]:h-[50%] sm:h-[40%] md:h-[30%] lg:h-[25%] mb-4 sm:mb-0 sm:mt-2 sm:mr-4' src={Smith} alt="Headshot of Sean Smith" />
                    <div className=''>
                        <h2 className="pb-2 text-xl underline underline-offset-4 text-red-600 drop-shadow-md">Sean Smith, DC – Vice President of Compliance</h2>
                        <p className="text-md">
                ...
                <div className="officer py-4 flex flex-col items-center md:flex-row mt-8">
                    <img className='w-[90%] min-[400px]:w-[50%] sm:w-[40%] md:w-[30%] lg:w-[25%] h-auto min-[400px]:h-[50%] sm:h-[40%] md:h-[30%] lg:h-[25%] mb-4 sm:mb-0 sm:mt-2 sm:mr-4' src={Hosman} alt="Headshot of Rhett Hosman" />
                    <div className=''>
                        <h2 className="pb-2 text-xl underline underline-offset-4 text-red-600 drop-shadow-md">Rhett Hosman – Treasurer</h2>
                        <p className="text-base">
                ...
                <div className="officer py-4 flex flex-col items-center md:flex-row mt-8">
                    <img className='w-[90%] min-[400px]:w-[50%] sm:w-[40%] md:w-[30%] lg:w-[25%] h-auto min-[400px]:h-[50%] sm:h-[40%] md:h-[30%] lg:h-[25%] mb-4 sm:mb-0 sm:mt-2 sm:mr-4' src={Rasmussen} alt="Headshot of Sammi Rasmussen" />
                    <div className=''>
                        <h2 className="pb-2 text-xl underline underline-offset-4 text-red-600 drop-shadow-md">Sammi Rasmussen – Secretary</h2>
                        <p className="text-base">
